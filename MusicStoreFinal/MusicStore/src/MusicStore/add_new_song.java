 ...
 * @author Mayank
 */
public class add_new_song extends javax.swing.JInternalFrame {

    /**
     * Creates new form add_new_song
     */
    public add_new_song() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      String ttle,atist,year,albm,genre;
        ...
        try{
            ...
            String a="insert into new_song values('"+ttle+"','"+atist+"','"+year+"','"+albm+"','"+genre+"');";
