 ...
 * @author Mayank
 */
public class update_new_song extends javax.swing.JInternalFrame {

    /**
     * Creates new form update_new_song
     */
    public update_new_song() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("UPDATE NEW SONG");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String a="update new_song set artist='"+atist+"',year='"+year+"',album='"+albm+"',genre='"+genre+"', where title='"+ttle+"'";
