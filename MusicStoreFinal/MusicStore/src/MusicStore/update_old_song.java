 ...
 * @author Mayank
 */
public class update_old_song extends javax.swing.JInternalFrame {

    /**
     * Creates new form update_old_song
     */
    public update_old_song() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("UPDATE OLD SONG");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String a="update old_song set artist='"+atist+"',year='"+year+"',album='"+albm+"',genre='"+genre+"', where title='"+ttle+"'";
